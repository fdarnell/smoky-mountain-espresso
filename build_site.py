...
<section class="cup-band" id="cup-band" aria-label="Interactive 3D Mocha Freeze">
  <script type="module" src="https://cdn.jsdelivr.net/npm/@google/model-viewer@4.2.0/dist/model-viewer.min.js"
          integrity="sha384-vxk4VLyK9yGAWdkf1mZ5Mps7pXW5Zfa3RypRIxvYNM9A9dhz44mM3mfIN1Bajb3B" crossorigin="anonymous"></script>
  <model-viewer
